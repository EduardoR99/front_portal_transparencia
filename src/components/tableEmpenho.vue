<template>
  <div class="overflow-x-auto">
    <div class="min-w-full">
      <table class="min-w-full text-[10px] bg-white p-6 text-primaryfont">
        <thead>
          <tr>
  ...
  <div class="flex justify-between mt-4">
    ...
    <button class="bg-blue-500 text-white px-4 py-2 rounded" @click="nextPage" :disabled="currentPage === totalPages">
      Próximo
    </button>
  </div>
</template>
